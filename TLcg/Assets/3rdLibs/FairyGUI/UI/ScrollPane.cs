...
namespace FairyGUI
{
	...
	public class ScrollPane : EventDispatcher
	{
		...
		internal bool _ismovingleft; //在左移
		float _snapToItemLeft; //向左滑动贴元件系数
		float _snapToItemRight;	//向右滑动贴元件系数
		...
		public ScrollPane(GComponent owner)
		{
			...
			_ismovingleft = false;
			_snapToItemLeft = 0.5f;
			_snapToItemRight = 0.5f;
		...
		/// 左滑贴元件系数 0 - 0.5
		/// </summary>
		public float snapToItemLeft
		{
			get { return _snapToItemLeft; }
			set {
					_snapToItemLeft = value;
					_snapToItemLeft = Math.Max(_snapToItemLeft, 0);
					_snapToItemLeft = Math.Min(_snapToItemLeft, 0.5f);					
				}
		}
		...
		/// 右滑贴元件系数 0 - 0.5
		/// </summary>
		public float snapToItemRight
		{
			get { return _snapToItemRight; }
			set { 
					_snapToItemRight = value;
					_snapToItemRight = Math.Max(_snapToItemRight, 0);
					_snapToItemRight = Math.Min(_snapToItemRight, 0.5f);	 
				}
		}
